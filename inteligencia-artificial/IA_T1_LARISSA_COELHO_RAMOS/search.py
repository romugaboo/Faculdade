...
def breadthFirstSearch(problem):
    ...
    "*** YOUR CODE HERE ***"
    start_node = getStartNode(problem)
    frontier = util.Queue()
    ...
    while not frontier.isEmpty():
        ...
        if problem.isGoalState(current_node['STATE']):
            return getActionSequence(current_node)

        for successor in problem.expand(current_node['STATE']):
            child_node = getChildNode(successor, current_node)
